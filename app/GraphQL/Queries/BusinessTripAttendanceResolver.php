...
class BusinessTripAttendanceResolver
{
    ...
    public function __construct(BusinessTripAttendanceRepositoryInterface $businessTripAttendanceRepository)
    {
    ...
    {
        return $this->businessTripAttendanceRepository->get($args);
    }
